...
**When to use**: Looking up specific script usage or parameters
...
**When to use**: Post-initialization reference
...
├── New Game / Augmentation → Getting Started/NEW_GAME_QUICKSTART.md 🆕
├── Quick Start → Getting Started/GETTING_STARTED.md
│   └── Detailed Usage → Reference/SCRIPT_REFERENCE.md
│
├── Structure → Reference/PROJECT_STRUCTURE.md
│   └── Changes → Version History/DETAILED_CHANGES.md
│
└── Technical → Version History/Enhancements/ERROR_HANDLING_IMPROVEMENTS.md
...
3. **Review error messages** in Version History/Enhancements/ERROR_HANDLING_IMPROVEMENTS.md
